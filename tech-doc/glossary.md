...
| Lager | Mobile warehouse (trailer) | — | The trailer used as a mobile warehouse at the exhibition. The physical object is the truck trailer (Anhänger). |
...
| Stand | Exhibition stand | — | The exhibition booth where goods from the truck are displayed |
